...
This branch of the `meta-ankaios` layer targets **Yocto 4.0 "Kirkstone" (LTS)** and
...
> [!NOTE]
> This is the release branch for Yocto 4.0 "Kirkstone". Other Yocto releases are
...
newer Rust toolchain than Kirkstone ships. Use `main` (or a newer release branch) for
the build-from-source recipe.

## Compatibility

This branch is compatible with Yocto 4.0 "Kirkstone"
...
```shell
git clone -b kirkstone https://github.com/eclipse-ankaios/meta-ankaios.git
