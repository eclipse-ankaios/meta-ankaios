# meta-ankaios (whinlatter branch)
...
This branch of the `meta-ankaios` layer targets **Yocto 5.3 "Whinlatter"** and
...
> [!NOTE]
> This is the release branch for Yocto 5.3 "Whinlatter". Other Yocto releases are
...
This branch is compatible with Yocto 5.3 "Whinlatter"
(`LAYERSERIES_COMPAT_meta-ankaios = "whinlatter"`).
...
```shell
git clone -b whinlatter https://github.com/eclipse-ankaios/meta-ankaios.git
